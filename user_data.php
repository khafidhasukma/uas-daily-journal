<table class="table table-hover">
    <thead class="table-dark">
        <tr>
            ...
            <th class="w-25">Dibuat tanggal</th>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="formGroupExampleInput3" class="form-label">Photo
                                            Lama</label>
                                        <?php
                                        if ($row["photo"] != '') {
                                            if (file_exists('img/' . $row["photo"])) {
                                        ?>
                                        <br><img src="img/<?= $row["photo"] ?>" width="100">
                                        <?php
                                            }
                                        }
                                        ?>
...
function formatDate($tanggal)
{
    ...
    $hari = $tanggalExplode[2];
    $bulanIndo = $bulan[(int)$tanggalExplode[1]];
